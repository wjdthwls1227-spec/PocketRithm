          ...
          <div className="card-toss p-10">
            ...
            <div className="space-y-6 text-sm" style={{ color: '#565656', lineHeight: '1.8' }}>
              <section>
                ...
                <p>
                  포켓리즘(PocketRithm, 이하 &quot;회사&quot;)은 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 개인정보 보호법 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.
                </p>
